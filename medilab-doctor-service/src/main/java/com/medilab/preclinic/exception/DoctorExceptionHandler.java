...
public class DoctorExceptionHandler {
	...
	private static final Logger logger = Logger.getLogger(DoctorExceptionHandler.class);
	
	@ExceptionHandler
	public ResponseEntity<ApiError> handleDeptNotFound(DoctorNotFound dnf){
	...
	@ExceptionHandler
	public ResponseEntity<ApiError> handleDeptCrateException(DoctorCreationException dce){
		logger.info("DepartmentExceptionHandler-->handleDeptNotFound");
